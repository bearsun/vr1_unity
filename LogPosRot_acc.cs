...
/// </summary>
public class LogPosRot_acc : MonoBehaviour
{
...
//        filePath 		 = "";  // don't use a path here
    ...
    void FixedUpdate()
    {
        ...
        else
        {
            ...
            boxcounter = transform.parent.gameObject.GetComponent<move_acc>().boxchecked;
            trialcounter = transform.parent.gameObject.GetComponent<move_acc>().trial;
            balance = transform.parent.gameObject.GetComponent<move_acc>().money;
            tempTime = Time.time;
