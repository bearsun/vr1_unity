...
public class move : MonoBehaviour {
    ...
    // random sequence
    private int[,] seq = new int[24, 2] {{4,3},
{4,2},
{4,7},
{4,5},
{4,6},
...
{2,4}};
    ...
    void Start()
    {
        ...
        datawriter.WriteLine("trial; start_room; target; boxchecked; searchT\r\n");
    ...
    public void StartTrial()
    {
        if (trial > 0)
        {
            ...
            string line = String.Format("{0,2};{1,1};{2,1};{3,1};{4,3:f3}\r\n",
                                               trial, startindex, objindex, boxchecked, stime);
        ...
        foreach (GameObject obj in objs)
        {
            obj.GetComponent<visibility>().Start();
        }
